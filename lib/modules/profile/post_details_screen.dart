...
class PostDetailsScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) {
        LayoutCubit.getCubit(context).getLikeStatusForMeOnSpecificPost(postMakerID: model.userID!, postID: postID);
                              ...
                              onTap:()
                              {
                                setState((){
                                  ...
                                  else
                                  {
                                    ...
                                    cubit.likeStatusForMeOnSpecificPost = true ;
                                    cubit.usersPostsData.clear();
                                    cubit.likesPostsData.clear();
                                    cubit.getUsersPosts();
                                  }
